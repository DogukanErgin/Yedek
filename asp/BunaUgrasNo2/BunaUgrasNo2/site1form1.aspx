<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="site1form1.aspx.cs" Inherits="BunaUgrasNo2.site1form1" %>
...
<link href="site1/layout/styles/layout.css" rel="stylesheet" type="text/css" media="all"/>
</head>
...
<div class="bgded overlay light" style="background-image:url('site1/images/demo/backgrounds/01.png');"> 
  <!-- ################################################################################################ -->
      ...
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Pages</a>
            <ul>
              <li><a href="site1/pages/gallery.html">Gallery</a></li>
              <li><a href="site1/pages/full-width.html">Full Width</a></li>
              <li><a href="site1/pages/sidebar-left.html">Sidebar Left</a></li>
              <li><a href="site1/pages/sidebar-right.html">Sidebar Right</a></li>
              <li><a href="site1/pages/basic-grid.html">Basic Grid</a></li>
            </ul>
          </li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="group excerpt">
      <article class="one_third first"><a class="imgover btmspace-30" href="#"><img src="site1/images/demo/320x240.png" alt=""></a>
      ...
      <article class="one_third"><a class="imgover btmspace-30" href="#"><img src="site1/images/demo/320x240.png" alt=""></a>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper row2 bgded overlay" style="background-image:url('site1/images/demo/backgrounds/02.png');">
...
<div class="wrapper row3">
  <figure class="hoc container clear"> 
    ...
    <ul class="nospace group center overview">
      <li class="one_third"><a class="imgover" href="#"><img src="site1/images/demo/320x418.png" alt=""></a></li>
      <li class="one_third"><a class="imgover" href="#"><img src="site1/images/demo/320x418.png" alt=""></a></li>
      <li class="one_third"><a class="imgover" href="#"><img src="site1/images/demo/320x418.png" alt=""></a></li>
    </ul>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper row2 bgded overlay" style="background-image:url('site1/images/demo/backgrounds/03.png');">
  <section class="hoc container clear testimonials"> 
    ...
    <ul class="nospace group btmspace-80">
      <li class="one_half first">
        ...
        <figure class="clear"><img src="site1/images/demo/60x60.png" alt="">
          <figcaption>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper row2 bgded overlay" style="background-image:url('site1/images/demo/backgrounds/04.png');">
...
<!-- JAVASCRIPTS -->
<script src="site1/layout/scripts/jquery.min.js"></script>
<script src="site1/layout/scripts/jquery.backtotop.js"></script>
<script src="site1/layout/scripts/jquery.mobilemenu.js"></script>
</body>
    </body>
</html>
